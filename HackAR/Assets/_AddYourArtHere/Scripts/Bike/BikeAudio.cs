...
namespace UnityStandardAssets.Vehicles.Bike
{
    ...
    public class BikeAudio : MonoBehaviour
    {
        ...
        private BikeController m_BikeController; // Reference to car we are controlling
        ...
        private void Update()
        {
            ...
            if (m_StartedSound)
            {
                ...
                float pitch = ULerp(lowPitchMin, lowPitchMax, m_BikeController.Revs);
                ...
                else
                {
                    ...
                    float accFade = Mathf.Abs(m_BikeController.AccelInput);
                    float decFade = 1 - accFade;

                    // get the high fade value based on the cars revs
                    float highFade = Mathf.InverseLerp(0.2f, 0.8f, m_BikeController.Revs);
